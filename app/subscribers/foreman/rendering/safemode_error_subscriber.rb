module Foreman
  module Rendering
    class SafemodeErrorSubscriber < ::Foreman::BaseSubscriber
      def call(event)
        ...
        combination.update_attributes!(safemode_status: HostStatus::RenderingStatusCombination::ERROR)

        # add warnings
        HostStatus::RenderingStatusCombination.where(template_id: template_id)
                                              .where(safemode_status: HostStatus::RenderingStatusCombination::OK)
