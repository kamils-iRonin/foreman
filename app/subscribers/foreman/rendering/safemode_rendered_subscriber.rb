module Foreman
  module Rendering
    class SafemodeRenderedSubscriber < ::Foreman::BaseSubscriber
      def call(event)
        ...
        combination.update_attributes!(safemode_status: HostStatus::RenderingStatusCombination::OK)

        # remove warnings
        HostStatus::RenderingStatusCombination.where(template_id: template_id)
                                              .where(safemode_status: HostStatus::RenderingStatusCombination::WARN)
